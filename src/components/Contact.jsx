            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="bg-slate-900/40 border border-slate-800 p-8 md:p-12 rounded-4xl backdrop-blur-xl shadow-2xl">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <a href="https://wa.me/2347077975970" className="flex items-center gap-4 p-6 bg-slate-950/50 border border-slate-800 rounded-2xl hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all group">
