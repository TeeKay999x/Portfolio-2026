            ...
            <div className=''>
                <div className='grid md:grid-cols-[1.5fr_1fr] gap-12 items-center w-full'>
                    <div className='animate-bounce-in'>
                        <p className="font-mono text-sky-400 text-sm md:text-base mb-4 tracking-widest uppercase">Full-Stack Develope</p>
                        <h1 className='text-5xl md:text-7xl font-extrabold mb-6 leading-tight'>I build <span className='text-transparent bg-clip-text  bg-linear-to-r from-sky-400 to-blue-500'>Scalable digital experiences.</span></h1>
